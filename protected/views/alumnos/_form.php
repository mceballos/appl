		...
		<tr>	
			...
			<td>					
				<?php 
                    ...
                    if($model->isNewRecord){                  
                        echo '<input id="AlumnosPadreRut" name="Alumnos[padre_rut]" type="text"  onkeydown="validarNumeros(event)" size="10" maxlength="8" style="width: 135px;">- <input id="AlumnosPadreDv" name="Alumnos[padre_dv]" type="text" size="2" maxlength="1"/><a href="#" onclick="buscarApoderado(\'AlumnosPadreRut\',\'AlumnosPadreDv\',\'nombrePadre\');" rel="tooltip" class="btn-small find" data-original-title="Buscar"><i class="icon-search"></i></a>';
                    }else{
                        if(isset($model->padreRut)){
                            echo '<input id="AlumnosPadreRut" name="Alumnos[padre_rut]" value="'.$model->padreRut->rut.'" type="text"  onkeydown="validarNumeros(event)" size="10" maxlength="8" style="width: 135px;">- <input id="AlumnosPadreDv" name="Alumnos[padre_dv]" value="'.$model->padreRut->dv.'" type="text" size="2" maxlength="1"/><a href="#" onclick="buscarApoderado(\'AlumnosPadreRut\',\'AlumnosPadreDv\',\'nombrePadre\');" rel="tooltip" class="btn-small find" data-original-title="Buscar"><i class="icon-search"></i></a>';    
                        }else{
                            echo '<input id="AlumnosPadreRut" name="Alumnos[padre_rut]" value="" type="text"  onkeydown="validarNumeros(event)" size="10" maxlength="8" style="width: 135px;">- <input id="AlumnosPadreDv" name="Alumnos[padre_dv]" value="" type="text" size="2" maxlength="1"/><a href="#" onclick="buscarApoderado(\'AlumnosPadreRut\',\'AlumnosPadreDv\',\'nombrePadre\');" rel="tooltip" class="btn-small find" data-original-title="Buscar"><i class="icon-search"></i></a>';
                        }                        
                    }
					?>
