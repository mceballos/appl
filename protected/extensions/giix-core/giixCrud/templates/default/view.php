...
$this->menu=array(
	...
	array('label'=>Yii::t('app', 'Delete') . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('deleteIndex', 'id' => $model-><?php echo $this->tableSchema->primaryKey; ?>), 'confirm'=>'¿Seguro que desea borrar este elemento?')),
